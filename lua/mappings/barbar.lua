...
return {
  ...
  n = {
    ...
    ["<A-4>"] = { "<cmd>BufferGoto 4<CR>", "󰎭  Goto buffer 4", opts = opts },
    ["<A-5>"] = { "<cmd>BufferGoto 5<CR>", "󰎱  Goto buffer 5", opts = opts },
    ["<A-6>"] = { "<cmd>BufferGoto 6<CR>", "󰎳  Goto buffer 6", opts = opts },
    ["<A-7>"] = { "<cmd>BufferGoto 7<CR>", "󰎶  Goto buffer 7", opts = opts },
